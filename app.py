...
stores = ["7eleven","islandvintage","ross","abc","jackinthebox","safeway","apple","kfc","starbucks","bestbuy","subway","burgerking","lnlhawaiianbarbecue","tacobell","costcowholesale","longsdrugs","target","dominos","macys","times","donquijote","mcdonalds","walmart","downtoearth","mcdonalds","wendys","foodland","pandaexpress","wholefoods","hmart","papajohns","zippys","homedepot","pizzahut"] 
