...
stores = ["samsclub","7eleven","islandvintage","rossdressforless","abc","jackinthebox","safeway","apple","kfc","starbucks","bestbuy","subway","burgerking","lnlhawaiianbarbecue","tacobell","costcowholesale","longsdrugs","target","dominos","macys","times","donquijote","mcdonalds","walmart","downtoearth","mcdonalds","wendys","foodlandfarms","pandaexpress","wholefoods","hmart","papajohns","zippys","homedepot","pizzahut"] 
